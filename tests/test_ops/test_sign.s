...
0000000000001600 <E_2925n39>:
	...
	v_add_f32_e32 v0, 0x2b8cbccc, v0                           // 00000000165C: 060000FF 2B8CBCCC
	v_div_scale_f32 v1, null, v0, v0, s2                       // 000000001664: D6FC7C01 000A0100
	v_div_scale_f32 v4, vcc_lo, s2, v0, s2                     // 00000000166C: D6FC6A04 000A0002
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000001674: BF8700B2
	...
	v_fmac_f32_e32 v2, v3, v2                                  // 000000001688: 56040503
	...
	v_fma_f32 v5, -v1, v3, v4                                  // 000000001694: D6130005 24120701
	...
	v_fma_f32 v1, -v1, v3, v4                                  // 0000000016A4: D6130001 24120701
	...
	v_div_fixup_f32 v0, v1, v0, s2                             // 0000000016B8: D6270000 000A0101
	v_mov_b32_e32 v1, 0                                        // 0000000016C0: 7E020280
	global_store_b32 v1, v0, s[0:1]                            // 0000000016C4: DC6A0000 00000001
	s_nop 0                                                    // 0000000016CC: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 0000000016D0: BFB60003
	s_endpgm                                                   // 0000000016D4: BFB00000

...
0000000000001600 <r_135n1>:
	...
	s_clause 0x1                                               // 0000000016E4: BF850001
	s_load_b32 s2, s[22:23], 0x68                              // 0000000016E8: F400008B F8000068
	s_load_b64 s[0:1], s[22:23], 0x60                          // 0000000016F0: F404000B F8000060
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000016F8: BF870091
	v_add_f32_e32 v0, s3, v0                                   // 0000000016FC: 06000003
	v_add_f32_e32 v0, s4, v0                                   // 000000001700: 06000004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001704: BF870091
	v_add_f32_e32 v0, s5, v0                                   // 000000001708: 06000005
	v_add_f32_e32 v0, s6, v0                                   // 00000000170C: 06000006
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1)// 000000001710: BF8700A1
	v_add_f32_e32 v0, s7, v0                                   // 000000001714: 06000007
	s_waitcnt lgkmcnt(0)                                       // 000000001718: BF89FC07
	v_add_f32_e32 v0, s0, v0                                   // 00000000171C: 06000000
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001720: BF870091
	v_add_f32_e32 v0, s1, v0                                   // 000000001724: 06000001
	v_add_f32_e32 v0, s2, v0                                   // 000000001728: 06000002
	s_cbranch_scc0 65476                                       // 00000000172C: BFA1FFC4 <r_135n1+0x40>
	s_set_inst_prefetch_distance 0x2                           // 000000001730: BF840002
	v_mov_b32_e32 v1, 0                                        // 000000001734: 7E020280
	global_store_b32 v1, v0, s[16:17]                          // 000000001738: DC6A0000 00100001
	s_nop 0                                                    // 000000001740: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 000000001744: BFB60003
	s_endpgm                                                   // 000000001748: BFB00000

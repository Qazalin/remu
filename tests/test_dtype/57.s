...
0000000000001700 <r_2_2_2n2>:
	...
	s_cselect_b32 s2, -1, 0                                    // 000000001758: 980280C1
	s_add_i32 s3, s14, 2                                       // 00000000175C: 8103820E
	v_cndmask_b32_e64 v2, 0, 0x3c00, s2                        // 000000001760: D5010002 0009FE80 00003C00
	s_mul_hi_i32 s6, s3, 0x55555556                            // 00000000176C: 9706FF03 55555556
	s_lshr_b32 s7, s6, 31                                      // 000000001774: 85079F06
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)// 000000001778: BF870499
	s_add_i32 s6, s6, s7                                       // 00000000177C: 81060706
	s_mul_i32 s6, s6, 3                                        // 000000001780: 96068306
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)// 000000001784: BF870499
	s_sub_i32 s3, s3, s6                                       // 000000001788: 81830603
	s_cmp_lt_i32 s3, 1                                         // 00000000178C: BF048103
	s_cselect_b32 s2, -1, 0                                    // 000000001790: 980280C1
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_3) | instid1(SALU_CYCLE_1)// 000000001794: BF8704C9
	v_cndmask_b32_e64 v3, 0, 0x3c00, s2                        // 000000001798: D5010003 0009FE80 00003C00
	s_add_u32 s2, s0, s4                                       // 0000000017A4: 80020400
	s_addc_u32 s3, s1, s5                                      // 0000000017A8: 82030501
	s_ashr_i32 s15, s14, 31                                    // 0000000017AC: 860F9F0E
	s_lshl_b64 s[0:1], s[14:15], 1                             // 0000000017B0: 8480810E
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(SKIP_4) | instid1(VALU_DEP_1)// 0000000017B4: BF8700D9
	s_add_u32 s0, s2, s0                                       // 0000000017B8: 80000002
	s_addc_u32 s1, s3, s1                                      // 0000000017BC: 82010103
	s_waitcnt vmcnt(0)                                         // 0000000017C0: BF8903F7
	v_lshrrev_b32_e32 v4, 16, v1                               // 0000000017C4: 32080290
	v_fma_f16 v1, v2, v1, 0                                    // 0000000017C8: D6480001 02020302
	v_fmac_f16_e32 v1, v3, v4                                  // 0000000017D0: 6C020903
	global_store_b16 v0, v1, s[0:1]                            // 0000000017D4: DC660000 00000100

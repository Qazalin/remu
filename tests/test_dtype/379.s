...
0000000000001600 <E_3n27>:
	...
	v_sub_f32_e32 v0, 0x3fc90fdb, v0                           // 000000001634: 080000FF 3FC90FDB
	v_cmp_ngt_f32_e64 s2, 0x48000000, |v0|                     // 00000000163C: D41B0202 000200FF 48000000
	v_readfirstlane_b32 s3, v0                                 // 000000001648: 7E060500
	...
	s_cbranch_vccz 164                                         // 00000000165C: BFA300A4 <E_3n27+0x2f0>
	...
	v_mov_b32_e32 v1, s6                                       // 000000001798: 7E020206
	s_cselect_b32 s8, -1, 0                                    // 00000000179C: 980880C1
	v_alignbit_b32 v2, s3, s11, v1                             // 0000000017A0: D6160002 04041603
	v_alignbit_b32 v3, s11, s9, v1                             // 0000000017A8: D6160003 0404120B
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 0000000017B0: BF870112
	v_readfirstlane_b32 s6, v2                                 // 0000000017B4: 7E0C0502
	v_cndmask_b32_e64 v2, v3, s11, s8                          // 0000000017B8: D5010002 00201703
	...
	v_alignbit_b32 v3, s3, v2, 30                              // 0000000017CC: D6160003 027A0403
	...
	v_xor_b32_e32 v3, s6, v3                                   // 0000000017E8: 3A060606
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000017EC: BF870091
	v_clz_i32_u32_e32 v4, v3                                   // 0000000017F0: 7E087303
	v_min_u32_e32 v4, 32, v4                                   // 0000000017F4: 260808A0
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_2)// 0000000017F8: BF870131
	v_lshlrev_b32_e32 v6, 23, v4                               // 0000000017FC: 300C0897
	v_alignbit_b32 v1, s9, s7, v1                              // 000000001800: D6160001 04040E09
	v_sub_nc_u32_e32 v5, 31, v4                                // 000000001808: 4C0A089F
	v_cndmask_b32_e64 v1, v1, s9, s8                           // 00000000180C: D5010001 00201301
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001814: BF870121
	v_alignbit_b32 v2, v2, v1, 30                              // 000000001818: D6160002 027A0302
	v_alignbit_b32 v1, v1, s7, 30                              // 000000001820: D6160001 02780F01
	v_xor_b32_e32 v2, s6, v2                                   // 000000001828: 3A040406
	s_delay_alu instid0(VALU_DEP_2)                            // 00000000182C: BF870002
	v_xor_b32_e32 v1, s6, v1                                   // 000000001830: 3A020206
	...
	v_alignbit_b32 v3, v3, v2, v5                              // 000000001840: D6160003 04160503
	v_alignbit_b32 v1, v2, v1, v5                              // 000000001848: D6160001 04160302
	s_or_b32 s7, s6, 0.5                                       // 000000001850: 8C07F006
	s_add_i32 s3, s10, s3                                      // 000000001854: 8103030A
	v_sub_nc_u32_e32 v6, s7, v6                                // 000000001858: 4C0C0C07
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000185C: BF870092
	v_alignbit_b32 v2, v3, v1, 9                               // 000000001860: D6160002 02260303
	v_clz_i32_u32_e32 v5, v2                                   // 000000001868: 7E0A7302
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000186C: BF870091
	v_min_u32_e32 v5, 32, v5                                   // 000000001870: 260A0AA0
	v_sub_nc_u32_e32 v7, 31, v5                                // 000000001874: 4C0E0A9F
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001878: BF870121
	v_alignbit_b32 v1, v2, v1, v7                              // 00000000187C: D6160001 041E0302
	v_lshrrev_b32_e32 v2, 9, v3                                // 000000001884: 32040689
	v_lshrrev_b32_e32 v1, 9, v1                                // 000000001888: 32020289
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_1) | instid1(VALU_DEP_1)// 00000000188C: BF8700A2
	v_or_b32_e32 v2, v2, v6                                    // 000000001890: 38040D02
	v_add_nc_u32_e32 v4, v5, v4                                // 000000001894: 4A080905
	v_lshlrev_b32_e32 v3, 23, v4                               // 000000001898: 30060897
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_4)// 00000000189C: BF870211
	v_sub_nc_u32_e32 v1, v1, v3                                // 0000000018A0: 4C020701
	v_mul_f32_e32 v3, 0x3fc90fda, v2                           // 0000000018A4: 100604FF 3FC90FDA
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 0000000018AC: BF870112
	v_add_nc_u32_e32 v1, 0x33000000, v1                        // 0000000018B0: 4A0202FF 33000000
	v_fma_f32 v4, 0x3fc90fda, v2, -v3                          // 0000000018B8: D6130004 840E04FF 3FC90FDA
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 0000000018C4: BF870112
	v_or_b32_e32 v1, s6, v1                                    // 0000000018C8: 38020206
	v_fmac_f32_e32 v4, 0x33a22168, v2                          // 0000000018CC: 560804FF 33A22168
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000018D4: BF870091
	v_fmac_f32_e32 v4, 0x3fc90fda, v1                          // 0000000018D8: 560802FF 3FC90FDA
	v_add_f32_e32 v1, v3, v4                                   // 0000000018E0: 06020903
	s_cbranch_execz 2                                          // 0000000018E4: BFA50002 <E_3n27+0x2f0>
	v_mov_b32_e32 v2, s3                                       // 0000000018E8: 7E040203
	s_branch 14                                                // 0000000018EC: BFA0000E <E_3n27+0x328>
	v_mul_f32_e64 v1, 0x3f22f983, s2                           // 0000000018F0: D5080001 000004FF 3F22F983
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000018FC: BF870091
	v_rndne_f32_e32 v2, v1                                     // 000000001900: 7E044701
	v_fma_f32 v1, 0xbfc90fda, v2, s2                           // 000000001904: D6130001 000A04FF BFC90FDA
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001910: BF870091
	v_fmac_f32_e32 v1, 0xb3a22168, v2                          // 000000001914: 560204FF B3A22168
	v_fmac_f32_e32 v1, 0xa7c234c4, v2                          // 00000000191C: 560204FF A7C234C4
	v_cvt_i32_f32_e32 v2, v2                                   // 000000001924: 7E041102
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)// 000000001928: BF870141
	v_dual_mul_f32 v3, v1, v1 :: v_dual_lshlrev_b32 v6, 30, v2 // 00000000192C: C8E20301 0306049E
	s_mov_b32 s3, 0xb94c1982                                   // 000000001934: BE8300FF B94C1982
	s_mov_b32 s6, 0x37d75334                                   // 00000000193C: BE8600FF 37D75334
	v_xor_b32_e32 v0, s2, v0                                   // 000000001944: 3A000002
	v_fmaak_f32 v4, s3, v3, 0x3c0881c4                         // 000000001948: 5A080603 3C0881C4
	s_lshl_b64 s[4:5], s[4:5], 2                               // 000000001950: 84848204
	v_and_b32_e32 v2, 1, v2                                    // 000000001954: 36040481
	s_add_u32 s0, s0, s4                                       // 000000001958: 80000400
	s_addc_u32 s1, s1, s5                                      // 00000000195C: 82010501
	v_fmaak_f32 v4, v3, v4, 0xbe2aaa9d                         // 000000001960: 5A080903 BE2AAA9D
	v_fmaak_f32 v5, s6, v3, 0xbab64f3b                         // 000000001968: 5A0A0606 BAB64F3B
	v_cmp_eq_u32_e32 vcc_lo, 0, v2                             // 000000001970: 7C940480
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000001974: BF870193
	v_mul_f32_e32 v4, v3, v4                                   // 000000001978: 10080903
	v_fmaak_f32 v5, v3, v5, 0x3d2aabf7                         // 00000000197C: 5A0A0B03 3D2AABF7
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001984: BF870112
	v_dual_fmac_f32 v1, v1, v4 :: v_dual_and_b32 v6, 0x80000000, v6// 000000001988: C8240901 01060CFF 80000000
	v_fmaak_f32 v5, v3, v5, 0xbf000004                         // 000000001994: 5A0A0B03 BF000004
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 00000000199C: BF870112
	v_xor_b32_e32 v0, v0, v6                                   // 0000000019A0: 3A000D00
	v_fma_f32 v3, v3, v5, 1.0                                  // 0000000019A4: D6130003 03CA0B03
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 0000000019AC: BF870121
	v_cndmask_b32_e32 v1, v3, v1, vcc_lo                       // 0000000019B0: 02020303
	v_cmp_class_f32_e64 vcc_lo, s2, 0x1f8                      // 0000000019B4: D47E006A 0001FE02 000001F8
	v_xor_b32_e32 v0, v0, v1                                   // 0000000019C0: 3A000300
	s_delay_alu instid0(VALU_DEP_1)                            // 0000000019C4: BF870001
	v_dual_mov_b32 v1, 0 :: v_dual_cndmask_b32 v0, 0x7fc00000, v0// 0000000019C8: CA120080 010000FF 7FC00000
	global_store_b32 v1, v0, s[0:1]                            // 0000000019D4: DC6A0000 00000001
	s_nop 0                                                    // 0000000019DC: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 0000000019E0: BFB60003
	s_endpgm                                                   // 0000000019E4: BFB00000

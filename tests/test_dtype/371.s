...
0000000000001600 <E_3n19>:
	...
	v_cvt_f32_i32_e32 v0, s2                                   // 000000001638: 7E000A02
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 00000000163C: BF870091
	v_mul_f32_e32 v0, 0xbfb8aa3b, v0                           // 000000001640: 100000FF BFB8AA3B
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001668: BF870092
	v_add_f32_e32 v0, v0, v2                                   // 00000000166C: 06000500
	...
	v_add_f32_e32 v0, 1.0, v0                                  // 000000001680: 060000F2
	...
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000001694: BF8700B2
	v_rcp_f32_e32 v2, v1                                       // 000000001698: 7E045501
	s_waitcnt_depctr 0xfff                                     // 00000000169C: BF880FFF
	v_fma_f32 v3, -v1, v2, 1.0                                 // 0000000016A0: D6130003 23CA0501
	...
	v_mul_f32_e32 v3, v4, v2                                   // 0000000016B0: 10060504
	...
	v_fmac_f32_e32 v3, v5, v2                                  // 0000000016C0: 56060505
	...
	v_div_fmas_f32 v1, v1, v2, v3                              // 0000000016D0: D6370001 040E0501

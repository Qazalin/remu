...
0000000000001600 <E_3n66>:
	...
	s_cbranch_vccz 166                                         // 000000001698: BFA300A6 <E_3n66+0x334>
	...
	s_cbranch_execz 4                                          // 000000001928: BFA50004 <E_3n66+0x33c>
	v_mov_b32_e32 v2, s6                                       // 00000000192C: 7E040206
	s_branch 16                                                // 000000001930: BFA00010 <E_3n66+0x374>
	s_and_not1_b32 vcc_lo, exec_lo, s3                         // 000000001934: 916A037E
	s_cbranch_vccnz 65532                                      // 000000001938: BFA4FFFC <E_3n66+0x32c>
	...
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_3) | instid1(VALU_DEP_2)// 000000001974: BF870141
	v_dual_mul_f32 v3, v1, v1 :: v_dual_lshlrev_b32 v6, 30, v2 // 000000001978: C8E20301 0306049E
	s_mov_b32 s3, 0xb94c1982                                   // 000000001980: BE8300FF B94C1982
	s_mov_b32 s6, 0x37d75334                                   // 000000001988: BE8600FF 37D75334
	v_xor_b32_e32 v0, s2, v0                                   // 000000001990: 3A000002
	v_fmaak_f32 v4, s3, v3, 0x3c0881c4                         // 000000001994: 5A080603 3C0881C4
	s_lshl_b64 s[4:5], s[4:5], 2                               // 00000000199C: 84848204
	v_and_b32_e32 v2, 1, v2                                    // 0000000019A0: 36040481
	s_add_u32 s0, s0, s4                                       // 0000000019A4: 80000400
	s_addc_u32 s1, s1, s5                                      // 0000000019A8: 82010501
	v_fmaak_f32 v4, v3, v4, 0xbe2aaa9d                         // 0000000019AC: 5A080903 BE2AAA9D
	v_fmaak_f32 v5, s6, v3, 0xbab64f3b                         // 0000000019B4: 5A0A0606 BAB64F3B
	v_cmp_eq_u32_e32 vcc_lo, 0, v2                             // 0000000019BC: 7C940480
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 0000000019C0: BF870193
	v_mul_f32_e32 v4, v3, v4                                   // 0000000019C4: 10080903
	v_fmaak_f32 v5, v3, v5, 0x3d2aabf7                         // 0000000019C8: 5A0A0B03 3D2AABF7
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 0000000019D0: BF870112
	v_dual_fmac_f32 v1, v1, v4 :: v_dual_and_b32 v6, 0x80000000, v6// 0000000019D4: C8240901 01060CFF 80000000
	v_fmaak_f32 v5, v3, v5, 0xbf000004                         // 0000000019E0: 5A0A0B03 BF000004
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 0000000019E8: BF870112
	v_xor_b32_e32 v0, v0, v6                                   // 0000000019EC: 3A000D00
	v_fma_f32 v3, v3, v5, 1.0                                  // 0000000019F0: D6130003 03CA0B03
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 0000000019F8: BF870121
	v_cndmask_b32_e32 v1, v3, v1, vcc_lo                       // 0000000019FC: 02020303
	v_cmp_class_f32_e64 vcc_lo, s2, 0x1f8                      // 000000001A00: D47E006A 0001FE02 000001F8
	v_xor_b32_e32 v0, v0, v1                                   // 000000001A0C: 3A000300
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001A10: BF870001
	v_dual_mov_b32 v1, 0 :: v_dual_cndmask_b32 v0, 0x7fc00000, v0// 000000001A14: CA120080 010000FF 7FC00000
	global_store_b32 v1, v0, s[0:1]                            // 000000001A20: DC6A0000 00000001
	s_nop 0                                                    // 000000001A28: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 000000001A2C: BFB60003
	s_endpgm                                                   // 000000001A30: BFB00000

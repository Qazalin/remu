...
0000000000001600 <E_3n38>:
	...
	global_load_i16 v0, v0, s[2:3]                             // 000000001624: DC4E0000 00020000
	s_waitcnt vmcnt(0)                                         // 00000000162C: BF8903F7
	v_cvt_f32_i32_e32 v0, v0                                   // 000000001630: 7E000B00
	...
	s_cbranch_vccz 164                                         // 000000001658: BFA300A4 <E_3n38+0x2ec>
	...
	s_cbranch_execz 2                                          // 0000000018E0: BFA50002 <E_3n38+0x2ec>
	v_mov_b32_e32 v2, s3                                       // 0000000018E4: 7E040203
	s_branch 14                                                // 0000000018E8: BFA0000E <E_3n38+0x324>
	...
	s_cbranch_vccz 164                                         // 000000001950: BFA300A4 <E_3n38+0x5e4>
	...
	s_cbranch_execz 2                                          // 000000001BD8: BFA50002 <E_3n38+0x5e4>
	v_mov_b32_e32 v5, s6                                       // 000000001BDC: 7E0A0206
	s_branch 14                                                // 000000001BE0: BFA0000E <E_3n38+0x61c>
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001C90: BF870113
	v_dual_fmaak_f32 v12, s7, v8, 0xbab64f3b :: v_dual_fmac_f32 v1, v1, v9// 000000001C94: C8401007 0C001301 BAB64F3B
	v_dual_mul_f32 v10, v8, v10 :: v_dual_fmaak_f32 v7, v6, v7, 0xbf000004// 000000001CA0: C8C21508 0A060F06 BF000004
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001CAC: BF870112
	v_fmaak_f32 v11, v8, v12, 0x3d2aabf7                       // 000000001CB0: 5A161908 3D2AABF7
	v_fmac_f32_e32 v4, v4, v10                                 // 000000001CB8: 56081504
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001CBC: BF870093
	v_fma_f32 v6, v6, v7, 1.0                                  // 000000001CC0: D6130006 03CA0F06
	v_cndmask_b32_e32 v1, v6, v1, vcc_lo                       // 000000001CC8: 02020306
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_2) | instid1(VALU_DEP_1)// 000000001CCC: BF8700B1
	...
	v_cmp_eq_u32_e32 vcc_lo, 0, v5                             // 000000001CDC: 7C940A80
	v_fmaak_f32 v11, v8, v11, 0xbf000004                       // 000000001CE0: 5A161708 BF000004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001CE8: BF870091
	v_fma_f32 v7, v8, v11, 1.0                                 // 000000001CEC: D6130007 03CA1708
	v_cndmask_b32_e32 v2, v7, v4, vcc_lo                       // 000000001CF4: 02040907
	v_cmp_class_f32_e64 vcc_lo, s2, 0x1f8                      // 000000001CF8: D47E006A 0001FE02 000001F8
	v_cndmask_b32_e32 v0, 0x7fc00000, v0, vcc_lo               // 000000001D04: 020000FF 7FC00000
	v_and_b32_e32 v8, 0x80000000, v9                           // 000000001D0C: 361012FF 80000000
	v_cmp_class_f32_e64 vcc_lo, s3, 0x1f8                      // 000000001D14: D47E006A 0001FE03 000001F8
	s_lshl_b64 s[2:3], s[4:5], 2                               // 000000001D20: 84828204
	s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(VALU_DEP_2)// 000000001D24: BF870119
	s_add_u32 s0, s0, s2                                       // 000000001D28: 80000200
	v_xor_b32_e32 v3, v3, v8                                   // 000000001D2C: 3A061103
	s_addc_u32 s1, s1, s3                                      // 000000001D30: 82010301
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D34: BF870091
	v_xor_b32_e32 v1, v3, v2                                   // 000000001D38: 3A020503
	v_cndmask_b32_e32 v1, 0x7fc00000, v1, vcc_lo               // 000000001D3C: 020202FF 7FC00000
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_2)// 000000001D44: BF870121
	v_div_scale_f32 v2, null, v1, v1, v0                       // 000000001D48: D6FC7C02 04020301
	v_div_scale_f32 v5, vcc_lo, v0, v1, v0                     // 000000001D50: D6FC6A05 04020300
	v_rcp_f32_e32 v3, v2                                       // 000000001D58: 7E065502
	s_waitcnt_depctr 0xfff                                     // 000000001D5C: BF880FFF
	v_fma_f32 v4, -v2, v3, 1.0                                 // 000000001D60: D6130004 23CA0702
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D68: BF870091
	v_fmac_f32_e32 v3, v4, v3                                  // 000000001D6C: 56060704
	v_mul_f32_e32 v4, v5, v3                                   // 000000001D70: 10080705
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D74: BF870091
	v_fma_f32 v6, -v2, v4, v5                                  // 000000001D78: D6130006 24160902
	v_fmac_f32_e32 v4, v6, v3                                  // 000000001D80: 56080706
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001D84: BF870091
	v_fma_f32 v2, -v2, v4, v5                                  // 000000001D88: D6130002 24160902
	v_div_fmas_f32 v2, v2, v3, v4                              // 000000001D90: D6370002 04120702
	s_delay_alu instid0(VALU_DEP_1)                            // 000000001D98: BF870001
	v_div_fixup_f32 v0, v2, v1, v0                             // 000000001D9C: D6270000 04020302
	v_mov_b32_e32 v1, 0                                        // 000000001DA4: 7E020280
	global_store_b32 v1, v0, s[0:1]                            // 000000001DA8: DC6A0000 00000001
	s_nop 0                                                    // 000000001DB0: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 000000001DB4: BFB60003
	s_endpgm                                                   // 000000001DB8: BFB00000

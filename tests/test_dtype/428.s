...
0000000000001600 <E_3n76>:
	...
	s_cbranch_scc0 165                                         // 000000001644: BFA100A5 <E_3n76+0x2dc>
	...
	s_cbranch_execz 2                                          // 0000000018D0: BFA50002 <E_3n76+0x2dc>
	v_mov_b32_e32 v1, s3                                       // 0000000018D4: 7E020203
	s_branch 15                                                // 0000000018D8: BFA0000F <E_3n76+0x318>
	...
	v_dual_mul_f32 v2, v0, v0 :: v_dual_and_b32 v5, 1, v1      // 00000000191C: C8E40100 02040281
	s_mov_b32 s3, 0xb94c1982                                   // 000000001924: BE8300FF B94C1982
	s_mov_b32 s6, 0x37d75334                                   // 00000000192C: BE8600FF 37D75334
	s_add_u32 s0, s0, s4                                       // 000000001934: 80000400
	v_fmaak_f32 v3, s3, v2, 0x3c0881c4                         // 000000001938: 5A060403 3C0881C4
	v_cmp_eq_u32_e32 vcc_lo, 0, v5                             // 000000001940: 7C940A80
	s_addc_u32 s1, s1, s5                                      // 000000001944: 82010501
	v_lshlrev_b32_e32 v1, 30, v1                               // 000000001948: 3002029E
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3)// 00000000194C: BF8701A3
	v_fmaak_f32 v3, v2, v3, 0xbe2aaa9d                         // 000000001950: 5A060702 BE2AAA9D
	v_fmaak_f32 v4, s6, v2, 0xbab64f3b                         // 000000001958: 5A080406 BAB64F3B
	v_and_b32_e32 v1, 0x80000000, v1                           // 000000001960: 360202FF 80000000
	s_delay_alu instid0(VALU_DEP_3) | instskip(NEXT) | instid1(VALU_DEP_3)// 000000001968: BF870193
	...
	v_fmac_f32_e32 v0, v0, v3                                  // 00000000197C: 56000700
	v_fmaak_f32 v4, v2, v4, 0xbf000004                         // 000000001980: 5A080902 BF000004
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1)// 000000001988: BF870091
	v_fma_f32 v2, v2, v4, 1.0                                  // 00000000198C: D6130002 03CA0902
	v_cndmask_b32_e32 v0, v2, v0, vcc_lo                       // 000000001994: 02000102
	v_cmp_class_f32_e64 vcc_lo, s2, 0x1f8                      // 000000001998: D47E006A 0001FE02 000001F8
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1)// 0000000019A4: BF870092
	v_xor_b32_e32 v0, v1, v0                                   // 0000000019A8: 3A000101
	v_dual_mov_b32 v1, 0 :: v_dual_cndmask_b32 v0, 0x7fc00000, v0// 0000000019AC: CA120080 010000FF 7FC00000
	global_store_b32 v1, v0, s[0:1]                            // 0000000019B8: DC6A0000 00000001
	s_nop 0                                                    // 0000000019C0: BF800000
	s_sendmsg sendmsg(MSG_DEALLOC_VGPRS)                       // 0000000019C4: BFB60003
	s_endpgm                                                   // 0000000019C8: BFB00000

...
Remu is an RDNA3 emulator built to test correctness of RDNA3 code. It was used in [tinygrad's AMD CI](https://github.com/tinygrad/tinygrad) from [Jan 30, 2024](https://github.com/tinygrad/tinygrad/commit/5b46b0ff3d2e90fbc70a7d39834760fc5227f499) to [Jan 26, 2026](https://github.com/tinygrad/tinygrad/commit/be23776ba7c79a3713629b8cfbae06d051d4e7ad).
...
Remu provides FFI functions in src/lib.rs for running RDNA3 binaries.
...
To see the colors in action, try running `DEBUG=6 PYTHONPATH="." DEV=REMU python test/test_ops.py TestOps.test_arange_big`. See how only lane 0 writes to global memory:
```
